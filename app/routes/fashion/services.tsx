...
function services() {
  return (
    <Layout>
      <section className="m-8 ml-36 w-3/4">
        <p>THE BEST</p>
        <h1 className="buz-font font-semibold text-7xl mt-8">
      ...
      <h1 className="buz-font font-semibold text-8xl w-2/3 text-center mt-11 mr-auto ml-auto">
        YOUR TRULY BESPOKE EXPERIENCE
      </h1>

      <p className="w-1/2 text-center mt-11 mr-auto ml-auto">
      ...
      <section className="w-2/3 flex flex-row mt-11 mr-auto ml-auto">
        <div className="w-1/2">
          <img
      ...
      <section className="flex w-1/2 mr-auto ml-auto mt-11">
        <img
      ...
      <section className="m-8  w-1/2 mt-48 mr-auto ml-auto">
        <p>QUALITY</p>
        <h1 className="buz-font font-semibold text-7xl mt-8">
      ...
      <section className="mr-auto ml-56 mt-11 flex w-1/2">
        <p className="border-t border-yellow-600 w-80 mt-3 mr-3" />
      ...
      <section className="flex flex-col w-5/6 mt-24">
        ...
        <div className="flex mt-5 mb-28">
          ...
          <div className="flex  ml-36 flex-1">
